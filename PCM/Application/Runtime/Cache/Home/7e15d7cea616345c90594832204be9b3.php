...
<div class="foot-copyright">
	...
	$(document).ready(function(){
		$("#name1").val("<?php echo ($res["name1"]); ?>");
		$("#class1").val("<?php echo ($res["class1"]); ?>");
		$("#tel1").val("<?php echo ($res["tel1"]); ?>");
		$("#name2").val("<?php echo ($res["name2"]); ?>");
		$("#class2").val("<?php echo ($res["class2"]); ?>");
		$("#tel2").val("<?php echo ($res["tel2"]); ?>");
		$("#name3").val("<?php echo ($res["name3"]); ?>");
		$("#class3").val("<?php echo ($res["class3"]); ?>");
		$("#tel3").val("<?php echo ($res["tel3"]); ?>");
		$("#school").val("<?php echo ($res["school"]); ?>");
		$("#teacher").val("<?php echo ($res["teacher"]); ?>");
		$("#address").val("<?php echo ($res["address"]); ?>");
				...
				$.post("<?php echo U('Xxcx/resign');?>",
					{
						...
						if(data==1){
							alert("修改成功！");
							window.location.href="<?php echo U('Xxcx/index');?>";
						}else{
							alert("修改失败！");
						}
				});
