            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse mynavbar" role="navigation" aria-expanded="false">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="<?php echo U('Index/index');?>">网站首页</a></li>
        ...
        <div class="modal fade" id="login" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="padding-top:100px;">
           <div class="modal-dialog modal-sm">
              <div class="modal-content">
                 ...
                 <div class="modal-footer">
                    <a class="btn btn-primary" href="#forget" data-toggle="modal">忘记密码</a>                    
...
<div id="LG" class="container" style="padding:0px;">
	<div class="row-fluid">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 " style="padding-top:50px">
			<img class="img-rounded img-responsive" src="/djb/Public/Image/logo_2.jpg" />
		</div>
        <div class="col-xs-12 col-sm-7 col-md-8 col-lg-9 ">
			<div class="panel panel-primary">
			  	<div class="panel-heading">竞赛章程</div>
            ...
            <div class="panel-group" id="accordion">
               <div class="panel panel-info">
                  ...
                  <div id="collapseOne" class="panel-collapse collapse in">
                     <ul class="list-group">
                     <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list-group-item"><a href="<?php echo U('zxdt/news', array('id' => $vo[id]));?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                     </ul>
                  </div>
               </div>    
            </div>           
...
<div class="foot-copyright">
	...
	$(document).ready(function(){
		...
		if(info==1){
			alert("尚未开始报名，详情请关注最新动态！");
		}else if(info==2){
			alert("您已成功报名，如需修改请前往信息查询！");
		}else if(info==3){
			alert("请先登录！");
		}else if(info==4){
			alert("尚未开始上传，详情请关注最新动态！");
		}
